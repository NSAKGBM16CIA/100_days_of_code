...
# register a new user with a selection of their country
class RegistrationForm(FlaskForm):
    username = StringField('Nickname', validators=[DataRequired()])
    country = SelectField('Country', choices=list_of_countries, validators=[DataRequired()])
    password = PasswordField('Password', validators=[DataRequired()])
    submit = SubmitField('Sign me Up!')

#  fro those returning...login
